...
/* harmony reexport (unknown) */ __webpack_require__.d(__webpack_exports__, __WEBPACK_REEXPORT_OBJECT__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 1007)), "/Users/sarahkuss/code/next/my-movie-database/app/[genre]/page.js"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6969)), "/Users/sarahkuss/code/next/my-movie-database/app/layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 3174))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/sarahkuss/code/next/my-movie-database/app/[genre]/page.js"];
    
    const originalPathname = "/[genre]/page"
    const __next_app__ = {
...
function Page({ params: { genre } }) {
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("main", {
        className: "p-8",
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("h1", {
            className: "capitalize text-2xl text-orange-400 font-semibold",
            children: [
                genre,
                " Movies"
            ]
...
var __webpack_exports__ = __webpack_require__.X(0, [697,810,707], () => (__webpack_exec__(5879)));
